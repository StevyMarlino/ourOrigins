                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme home-slider">
                        @forelse ($posts as $post)
                            <div>
                                <a href="{{ route('details',$post->slug) }}" class="a-block d-flex align-items-center height-lg"
            ...
            <div class="row">
                @forelse ($alls6 as $post)
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ route('details',$post->slug) }}" class="a-block d-flex align-items-center height-md"
                            style="background-image: url({{ asset(Voyager::image($post->image)) }}); ">
                            <div class="text">
                                <div class="post-meta">
                                    <span class="category">{{ $post->category->name }}</span>
